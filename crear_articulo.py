...
('p','Estas escalas no se recalculan en cada fotograma. Así, una burbuja no cambia de significado al reproducir o retroceder. Los archivos de esta edición usan el prefijo 20260924 y el orquestador registra las etapas y resultados de la ejecución.'),
('break','')]
